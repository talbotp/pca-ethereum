...
save data/eth_covariance_matrix_supply.dat covMatrix -ascii;
...
save data/eth_eigenvalues_supply.dat eigenvalues_labels -ascii;

% Here, we save the eigenvectors

save data/eth_eigenvectors_supply.dat eigenvectors -ascii;
