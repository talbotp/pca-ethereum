...
load data/btc_eigenvalues.dat;

data = btc_eigenvalues;
...
save data/btc_variance_cum_frequency.dat cumulative_variance_percent -ascii;
...
print figures/scree_plot_btc.scree.eps -depsc;
