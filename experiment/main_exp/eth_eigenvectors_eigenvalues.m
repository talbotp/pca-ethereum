...
save data/eth_covariance_matrix.dat covMatrix -ascii;
...
save data/eth_eigenvalues.dat eigenvalues_labels -ascii;

% Here, we save the eigenvectors

save data/eth_eigenvectors.dat eigenvectors -ascii;
